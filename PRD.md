...
> Each social post is treated as an Event. From every post we automatically extract: What (topic/message), When (time/date), Where (location/district), Whom (people present/mentioned), and Said-What (core statement/quote).
